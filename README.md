...
|-------|----------------|----------------|
| Q1 Live occupancy (single gym) | &lt; 0.5 ms | `idx_checkins_live_occupancy` (actual: 0.166 ms) |
| Q2 Today’s revenue (single gym) | &lt; 0.8 ms | `idx_payments_gym_date` (actual: 0.137 ms) |
| Q3 Churn risk actives | &lt; 1 ms | `idx_members_churn_risk` (actual: 0.622 ms) |
| Q4 Heatmap (7d) | &lt; 0.3 ms | `gym_hourly_stats` (+ unique index) (actual: 0.082 ms) |
| Q5 Cross-gym 30d revenue | &lt; 2 ms | `idx_payments_date` (actual: 0.791 ms) |
| Q6 Active anomalies | &lt; 0.3 ms | `idx_anomalies_active` (actual: 0.128 ms) |
